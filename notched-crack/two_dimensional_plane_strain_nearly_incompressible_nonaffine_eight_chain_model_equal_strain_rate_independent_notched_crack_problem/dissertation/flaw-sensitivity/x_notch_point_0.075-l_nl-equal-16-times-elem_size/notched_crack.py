...
class NotchedCrack(TwoDimensionalPlaneStrainNearlyIncompressibleNonaffineEightChainModelEqualStrainRateIndependentCompositeuFJCNetworkNonlocalScissionNetworkFractureProblem):
    ...
    def set_user_parameters(self):
        ...
        dp["t_max"] = 10.71 # 6.44 # 8.32 # 6.2 # 5.8 # 4.4 # 30.0 # 33.0 # 30.0 # 13.6 # 13.5 # 16.0 # 100.0 # sec
...
if __name__ == '__main__':
    ...
    l_nl = 16*coarse_mesh_elem_size # 32*coarse_mesh_elem_size # 10*r_notch # 1.25*r_notch # 0.02 = 2*coarse_mesh_elem_size

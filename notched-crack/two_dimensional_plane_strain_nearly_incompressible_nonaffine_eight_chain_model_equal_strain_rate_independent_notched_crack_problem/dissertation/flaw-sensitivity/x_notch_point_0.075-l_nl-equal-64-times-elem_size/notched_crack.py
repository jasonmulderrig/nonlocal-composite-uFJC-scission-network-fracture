...
class NotchedCrack(TwoDimensionalPlaneStrainNearlyIncompressibleNonaffineEightChainModelEqualStrainRateIndependentCompositeuFJCNetworkNonlocalScissionNetworkFractureProblem):
    ...
    def set_user_parameters(self):
        ...
        dp["t_max"] = 20.00 # 6.44 # 8.32 # 6.2 # 5.8 # 4.4 # 30.0 # 33.0 # 30.0 # 13.6 # 13.5 # 16.0 # 100.0 # sec
        dp["t_step"] = 0.01 # 0.005 # 0.01 # 0.02 # sec
...
if __name__ == '__main__':
    ...
    L, H = 0.75, 3 # 10*x_notch_point, 40*x_notch_point # 1.0, 1.5
    ...
    l_nl = 64*coarse_mesh_elem_size # 10*r_notch # 1.25*r_notch # 0.02 = 2*coarse_mesh_elem_size

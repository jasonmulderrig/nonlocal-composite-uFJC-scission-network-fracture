...
class NotchedCrack(TwoDimensionalPlaneStrainNearlyIncompressibleNonaffineEightChainModelEqualStrainRateIndependentCompositeuFJCNetworkNonlocalScissionNetworkFractureProblem):
    ...
    def set_user_parameters(self):
        ...
        dp["t_max"] = 5.28 # 6.44 # 8.32 # 6.2 # 5.8 # 4.4 # 30.0 # 33.0 # 30.0 # 13.6 # 13.5 # 16.0 # 100.0 # sec
    ...
    def define_mesh(self):
        ...
        r_notch_string     = "{:.2f}".format(self.r_notch) # "{:.1f}".format(self.r_notch)
        coarse_mesh_elem_size_string  = "{:.3f}".format(self.coarse_mesh_elem_size) # "{:.2f}".format(self.coarse_mesh_elem_size)
...
if __name__ == '__main__':
    ...
    coarse_mesh_elem_size = 0.01 # 0.01 # 0.25 # 0.1
